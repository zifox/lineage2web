...
config. BgColor			= '#406072'	// Background colour (HTML colour value, in quotes)
...
config. CloseBtnColors	= ['#406072', '#FFFFFF', '#406072', '#FFFFFF']	// [Background, text, hovered background, hovered text] - use empty strings '' to inherit title colours
...
config. TitleBgColor	= '#406072'		// If empty string '', BorderColor will be used
