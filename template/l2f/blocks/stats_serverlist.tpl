...
<td align="left" width="25%"><a href="stat.php?stat=online&amp;server={ID}"><font color="green">{online_count}</font></a> / <a href="stat.php?stat=gm&amp;server={ID}"><font color="green">{online_gm_count}</font></a></td></tr>
</table><br />