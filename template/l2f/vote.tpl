<b>{vote_for_server}</b><br />

<script language="javascript" src="scripts/vote.js" type="text/javascript"></script>
<form id="vote" name="vote" method="post" action="vote.php?action=vote">
...
<div align="center">From now for voting you will receive {vote_reward} webpoints</div>
{button}
</form>