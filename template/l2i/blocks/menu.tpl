...
<tr onmouseover="this.bgColor = '#505050';" onmouseout="this.bgColor = ''"><td align="center" width="100%"><a href="index.php"><img src="./img/menu/{langpath}/home.png" border="0" width="150" title="{Home}" alt="{Home}" /></a></td></tr>
<tr onmouseover="this.bgColor = '#505050';" onmouseout="this.bgColor = ''"><td align="center"><a href="reg.php"><img src="./img/menu/{langpath}/reg.png" border="0" width="150" title="{Reg}" alt="{Reg}"/></a></td></tr>
