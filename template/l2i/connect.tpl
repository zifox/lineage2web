...
<li>Allows for unicode chat for Gracia: Epilogue (You can write in your language in the chat).</li>
...
<ol>
<li>Download the file. <a href="{static}/files/fantasy.exe">Fantasy World patch v1</a></li>
