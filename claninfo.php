...
if(isset($_GET['clan'])){
    ...
    if(mysql_num_rows($query))
    {
        ...
        <table><thead><th><?php echo $Lang['nr'];?></th><th><?php echo $Lang['name'];?></th><th><?php echo $Lang['sex'];?></th><th><?php echo $Lang['class'];?></th><th><?php echo $Lang['pvp_pk'];?></th></thead>
        <tbody>
        <?php
