...
<tr><td align="center"><a href="/forum/"><img src="./img/menu/<?php echo $langpath;?>/forum.png" border="0" width="120" title="<?php echo $Lang['forum'];?>" alt="<?php echo $Lang['forum'];?>"/></a></td></tr>
