...
<tr><td align="center"><a href="donate.php"><img src="./img/menu/<?php echo $langpath;?>/donate.png" border="0" width="150" title="<?php echo $Lang['Donate'];?>" alt="<?php echo $Lang['Donate'];?>"/></a></td></tr>
</table>
